...
${OBJECTDIR}/usb_config.o: usb_config.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/usb_config.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../microchip/include" -I"../common" -I"../microchip/common" -I"../microchip/usb" -I"../libusb" -MMD -MF "${OBJECTDIR}/usb_config.o.d" -o ${OBJECTDIR}/usb_config.o usb_config.c  
...
${OBJECTDIR}/_ext/455219722/usb_host.o: ../microchip/usb/usb_host.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/455219722/usb_host.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../microchip/include" -I"../common" -I"../microchip/common" -I"../microchip/usb" -I"../libusb" -MMD -MF "${OBJECTDIR}/_ext/455219722/usb_host.o.d" -o ${OBJECTDIR}/_ext/455219722/usb_host.o ../microchip/usb/usb_host.c  
...
${OBJECTDIR}/usb_config.o: usb_config.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/usb_config.o.d 
	@${FIXDEPS} "${OBJECTDIR}/usb_config.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../microchip/include" -I"../common" -I"../microchip/common" -I"../microchip/usb" -I"../libusb" -MMD -MF "${OBJECTDIR}/usb_config.o.d" -o ${OBJECTDIR}/usb_config.o usb_config.c  
	
${OBJECTDIR}/_ext/455219722/usb_host.o: ../microchip/usb/usb_host.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/455219722 
	@${RM} ${OBJECTDIR}/_ext/455219722/usb_host.o.d 
	@${FIXDEPS} "${OBJECTDIR}/_ext/455219722/usb_host.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../microchip/include" -I"../common" -I"../microchip/common" -I"../microchip/usb" -I"../libusb" -MMD -MF "${OBJECTDIR}/_ext/455219722/usb_host.o.d" -o ${OBJECTDIR}/_ext/455219722/usb_host.o ../microchip/usb/usb_host.c  
	
${OBJECTDIR}/usb_host_android.o: usb_host_android.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/usb_host_android.o.d 
	@${FIXDEPS} "${OBJECTDIR}/usb_host_android.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../microchip/include" -I"../common" -I"../microchip/common" -I"../microchip/usb" -I"../libusb" -MMD -MF "${OBJECTDIR}/usb_host_android.o.d" -o ${OBJECTDIR}/usb_host_android.o usb_host_android.c  
	
${OBJECTDIR}/usb_host_bluetooth.o: usb_host_bluetooth.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/usb_host_bluetooth.o.d 
	@${FIXDEPS} "${OBJECTDIR}/usb_host_bluetooth.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../microchip/include" -I"../common" -I"../microchip/common" -I"../microchip/usb" -I"../libusb" -MMD -MF "${OBJECTDIR}/usb_host_bluetooth.o.d" -o ${OBJECTDIR}/usb_host_bluetooth.o usb_host_bluetooth.c  
